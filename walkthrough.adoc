...
[[_eipy9l1bzxd7]] Preparing to deliver the workshop
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Instructor requirements:

* Being very comfortable with 3scale both in terms of configuration and
of operations. Knowing the basics of the Developer Portal
* Being comfortable with RH SSO and especially around OpenID Connect
protocol
* Being able to use Postman (or similar REST client) to build REST
request and REST authentication
...
https://docs.openshift.com/container-platform/3.11/architecture/infrastructure_components/web_console.html#browser-requirements[https://docs.openshift.com/container-platform/3.11/architecture/infrastructure_components/web_console.html#browser-requirements]
...
https://tutorial-web-app-webapp.apps.openbanking-fe8e.openshiftworkshop.com/[https://tutorial-web-app-webapp.apps.openbanking-]https://tutorial-web-app-webapp.apps.openbanking-fe8e.openshiftworkshop.com/[fe8e]https://tutorial-web-app-webapp.apps.openbanking-fe8e.openshiftworkshop.com/[.openshiftworkshop.com]
...
[[duration-and-format]]
[[_30j0zll]]Duration and format
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

This is a workshop designed for approximately 2 hours delivery. The
focus is on the adoption of the products to build a comprehensive
financial solution. This is not an introduction to the different
products used in the open banking solution portal, but it is focused on
the modules and functionalities relevant for the FSI industry.
Typically, instructors would talk through the introduction slides, and
then for each hands-on lab, explain the steps needed to achieve the
objective of the lab calling on the main functionalities of the
products. At the end of each activity there will be a checkpoint with
the attendees.
...
|30 minutes a|
_Start of Practical Part 1_

Financial Backend service demo and building blocks on Fuse Online
[hands-on of the attendees in parallel]

|25 minutes a|
Basics of Service Configuration and Integration in 3scale. Basics of
Developer portal content publishing
...
|10 minutes a|
_Start of Practical Part 2_

Introducing OIDC & OAuth [slides]

|30 minutes a|
Basics of RH SSO and 3scale OIDC API authentication
...
|10 minutes a|
(optional according to timing)

OpenShift high level walkthrough [simple demo]
...
https://tutorial-web-app-webapp.apps.openbanking-fe8e.openshiftworkshop.com/[https://tutorial-web-app-webapp.apps.openbanking-fe8e.openshiftworkshop.com]

image:images/e53f27072555fc95.png[image,width=624,height=271]

We will see how integr8ly environment works and what you get. It
provides out of the box integration between products but it doesn’t
change the base components that come with it. You can install yourself
this type of environment starting from a clean or empty OpenShift
installation.

[[fuse-online]]
[[_3dy6vkm]]Fuse Online
+++++++++++++++++++++++

Let’s start our first lab session, by opening Red Hat Fuse Online. You
will get there by clicking *Red Hat Fuse* link in the tutorial
dashboard. We will see the main functionalities of it and then use it to
build a simple integration block.

image:images/79764895c2c935a5.png[image,width=624,height=291]

 +

The main dashboard (*Home*) is the landing page and it is especially
important when you need to check messages coming from the requests being
sent and in general to give an overview of the deployed integration
blocks.

image:images/42eab354684343ed.png[image,width=624,height=211]

The integration window (*Integrations*) allows you to have a graphical
representation of the mediation/transformation and is the first tool to
onboard the citizen developers. Behind the curtains there is Camel
(which is a proven technology and deployed in highly transactional
environment as well) and although the connectors available right now are
just few the number will grow dramatically as this is the repository
http://camel.apache.org/components.html .

image:images/96672c415fe25036.png[image,width=624,height=204]

(*Connections*) you can start or end (or sometimes interpose)
connections which are fully configured connectors. We will be showing
the configuration of one connector during today’s lab.

Various connectors are available and new connectors are coming in the
future and will be ported onto Fuse Online.

image:images/a5b5ab9707b881b6.png[image,width=624,height=205]

(*Customizations*) there are two panes available here, the first one
dedicated to API connections, which we will be using afterwards as
Connection in the Integration.

image:images/7a990144c0f6736c.png[image,width=624,height=244]

(*Extensions* panel) this is the part where you can extend the
functionalities of the platform. You can compile a custom or community
available extension to perform a specific functionality or connect to a
specific system and in this easy way add transformation functionalities
to the product.
...
Let’s start by creating the connection to an existing DB that I
...
image:images/96672c415fe25036.png[image,width=624,height=293]
image:images/cc8e5b11ed8dc671.png[image,width=624,height=226]

Select *Database* connector

image:images/afc5ecffc2c5647.png[image,width=624,height=218]
...
image:images/73559a9acd287dcc.png[image,width=625,height=253]

Let’s name the connection and finalize the configuration of the
connector (*Create*).

 +

image:images/e54af7f9e9f361f0.png[image,width=626,height=192]

 +

image:images/27f751a316bb458c.png[image,width=609,height=274]
...
pieces together. *Integrations -> create integration*

image:images/280d22705b1b958d.png[image,width=624,height=185]
...
image:images/ed8669f693bd4125.png[image,width=630,height=321]

 +

 +

image:images/b0394fb1d4aa76f1.png[image,width=563,height=280]
...
image:images/ab579bf7c7c7a970.png[image,width=624,height=295]
...
image:images/779b713f06dc279c.png[image,width=608,height=272]

And *save and continue*

image:images/e32edb47852d1741.png[image,width=624,height=182]
...
image:images/47e3c25deb708969.png[image,width=624,height=254]

Click on *get list of banks*

image:images/22764bfa357fbe17.png[image,width=624,height=192]
...
image:images/46d6df461e6c631a.png[image,width=601,height=310]

Click on the previously configured data source.

image:images/21b2ac307322cf20.png[image,width=602,height=270]
...
image:images/b6979e02c028afc0.png[image,width=595,height=261]
...
image:images/5fb99be3a08333a3.png[image,width=624,height=218]

And now let’s add a simple log of the requests coming through. Add a
step.

image:images/82b4ed0da7a5fd2.png[image,width=624,height=196]

Select the log step.

image:images/98581be0c5f2ec73.png[image,width=624,height=193]
...
image:images/9ba03875f242b5e0.png[image,width=624,height=182]

We are going to log just the message body.

image:images/1e4a2d5544d458c1.png[image,width=624,height=231]

We are now ready to deploy and expose this integration in our platform,
to use it. Hit *Publish*

image:images/ad4c8088051091f7.png[image,width=624,height=195]
...
image:images/4a8146fd0ad53451.png[image,width=591,height=393]
...
image:images/5b1e8edd4c2fd8cb.png[image,width=570,height=378]

Show that everything went 200 fine and open the Response Body (eye icon)

image:images/83a67bd30b02d5f2.png[image,width=476,height=95]
...
image:images/fbbdd08773f7d951.png[image,width=624,height=317]
...
image:images/7ea5a1314c59ec66.png[image,width=565,height=315]
...
image:images/d60df648c3a5608c.png[image,width=615,height=171]
...
image:images/110f274df1b4c611.png[image,width=624,height=241]
...
image:images/2c4bc51aa8e15fca.png[image,width=624,height=144]
...
image:images/9fd97b34ec6b2225.png[image,width=624,height=324]
...
image:images/8bac22906f51784f.png[image,width=623,height=343]
...
image:images/ce482302584bc0be.png[image,width=618,height=257]
...
image:images/26af3be6a8c9a397.png[image,width=624,height=251]
...
image:images/cf46394b49ceedd3.png[image,width=624,height=273]

You can also customize the error returned to the end user. *Policies*

image:images/da30bcf933e150f0.png[image,width=624,height=300]

These are like additional plugin that you can configure to adapt the
service to your own preference. *Add Policy*

image:images/94e8c7035d81dcc8.png[image,width=624,height=304]
...
image:images/9fe54b4583cb1150.png[image,width=624,height=278]
...
image:images/acb4f3c100480178.png[image,width=624,height=324]
...
image:images/616acb12bebd94f5.png[image,width=624,height=315]
...
image:images/4e368ec757201950.png[image,width=624,height=211]
...
image:images/668958cd9c28fd37.png[image,width=624,height=295]
...
image:images/498ec8af8c7c1f6f.png[image,width=624,height=109]

image:images/e6825c2ff83122dd.png[image,width=624,height=276]
...
image:images/38ce69d07b691c0c.png[image,width=633,height=284]

We now have a pre-populated key in the example curl statement, let’s try
again testing the deployed configuration.

image:images/521ac6bcced523b3.png[image,width=619,height=271]
...
image:images/9081532fd1071a54.png[image,width=624,height=248]
...
image:images/7484dcb96be36e7f.png[image,width=624,height=328]

We are now logged in the developer’s dashboard. Let’s see the
Applications I have created

image:images/e17389bfabb24528.png[image,width=624,height=257]
...
image:images/d844d76199032049.png[image,width=564,height=348]
...
image:images/6b9b83227e4b5c61.png[image,width=624,height=293]
...
image:images/96dbe78ea40a3465.png[image,width=624,height=299]
...
image:images/fddc0fee533b6ed5.png[image,width=624,height=73]
...
image:images/8831e631641c6339.png[image,width=620,height=295]
...
image:images/e28d9c693abafded.png[image,width=560,height=323]
...
image:images/fd48e097b178ebbe.png[image,width=624,height=203]
...
image:images/2324d65796ea09f4.png[image,width=624,height=270]
...
image:images/7efedd3c16f5656b.png[image,width=520,height=238]
...
image:images/39390b96648e97fa.png[image,width=503,height=259]
...
image:images/7e6ba75693536cb.png[image,width=624,height=207]

We will fill in all the user details and switch to user email verified

image:images/9b1d407842e8c6c2.png[image,width=574,height=267]

Now we will set the password, by going to credentials and setting it to
_password_ and reset password.

image:images/a8644b7f2fca49c5.png[image,width=604,height=279]
...
image:images/2497a378b125866a.png[image,width=624,height=325]
...
image:images/68f608e7c269cf4d.png[image,width=624,height=325]

We are going to change it to OpenID Connect. *Update service*

image:images/bc3bd60863779aa7.png[image,width=624,height=325]
...
image:images/2f04b14f929ec230.png[image,width=624,height=324]
...
image:images/916e89e7d700f345.png[image,width=501,height=395]
...
image:images/d50d65d97688f892.png[image,width=624,height=264]

Let’s now switch user perspective and get in the shoes of the developer
and open their Applications section.

image:images/fac123499262120d.png[image,width=624,height=513]
...
image:images/c39ad9744bfbd9c1.png[image,width=527,height=199]

Let’s make sure that the application is now aligned in terms of
credentials both in 3scale and RH SSO.

image:images/f74213908594b9b1.png[image,width=624,height=325]

image:images/1c71f9c4b12979bd.png[image,width=614,height=266]

image:images/cdb9a6ebe35b05fb.png[image,width=603,height=321]
...
*SAVE*image:images/49b9879e91c55673.png[image,width=601,height=404]
...
image:images/a74a02136b460977.png[image,width=388,height=409]

Hit *Exchange*

image:images/803e834a46810204.png[image,width=482,height=450]
...
image:images/b1b7fdb8e4bbfd6f.png[image,width=427,height=319]
...
image:images/f768b20c937f3600.png[image,width=473,height=288]

Let’s now go back to https://openidconnect.net/ website and copy the
“access_token” value in the step 2 (the long string).

image:images/58ef826168594763.png[image,width=316,height=415]
...
image:images/d75c81d544f50343.png[image,width=624,height=149]

Let’s hit *Test*

image:images/102dee4cafcf2a9a.png[image,width=467,height=292]

And success!

image:images/f97f9066ba9ec021.png[image,width=321,height=269]
...
image:images/94cf31260f6228ed.png[image,width=624,height=271]
...
image:images/f14f20fc92b1507e.png[image,width=624,height=238]
...
image:images/f811f2d02f057f50.png[image,width=624,height=255]
...
image:images/c0cd9fdf543ff655.png[image,width=624,height=262]

We will now try as bad intentioned user to change some parameters around
the installed products.

image:images/83e67faa391814f8.png[image,width=624,height=275]

image:images/e6de76cfbb995876.png[image,width=575,height=304]

image:images/b769adf958203399.png[image,width=583,height=309]
...
image:images/572f00309b946a0e.png[image,width=624,height=244]
...
image:images/8c0af3aadd4d88f5.png[image,width=624,height=295]
...
image:images/83307e94164c4000.png[image,width=624,height=284]

image:images/3339cc10a8054cbb.png[image,width=624,height=259]

image:images/1de842adeb97d45e.png[image,width=624,height=181]

image:images/e7b64bd1399dc5ac.png[image,width=624,height=296]

As you can see we just deleted a Pod and we will verify that UI is
broken by accessing the interface of Fuse Online

image:images/9fcd39bec9b5a785.png[image,width=624,height=208]

image:images/243134ddf7069bc8.png[image,width=624,height=292]

image:images/5966ea7d7b8937a3.png[image,width=624,height=294]
